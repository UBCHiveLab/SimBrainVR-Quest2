...
public class LeanTween_Scale : MonoBehaviour
{
    [SerializeField] private bool useInDebug = default;
    [SerializeField] private Transform objectToUse = default;
    ...
    public void Activate()
    {
        ...
        {
            currentTweenId =
                LeanTween.scale(objectToUse.gameObject, target, tweenDuration)
                    .setFrom(setFrom)
                    .setEase(tweenType)
