...
public class VoiceRecognitionMindPalace : MonoBehaviour
{

    #region singleton
    private static VoiceRecognitionMindPalace _instance;

    public static VoiceRecognitionMindPalace Instance { get { return _instance; } }
